...
from app.schemas.user import PublicUserResponse, FollowStatusResponse, UserSearchResult
...
def follow_user(
    ...
    return follow_service.follow_user(db, user_id, current_user, background_tasks)
